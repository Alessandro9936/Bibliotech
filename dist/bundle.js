...
/* harmony import */ var _view__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view */ "./src/js/view.js");
...
const init = (() => {
  ...
  searchCategoryBtn.addEventListener("click", async () => {
    try {
      ...
      const booksArray = await _data__WEBPACK_IMPORTED_MODULE_4__.dataHandler.getBooksByCategory(category);
      _view__WEBPACK_IMPORTED_MODULE_5__.handleView.handleBookPreviews(booksArray);
    } catch (err) {
      console.error(err);
    }
  });
  ...
  window.addEventListener("click", async (e) => {
    if (
      ...
      const { clickedBook, bookDescription } =
        await _data__WEBPACK_IMPORTED_MODULE_4__.dataHandler.getBookDescription(bookInList);
      _view__WEBPACK_IMPORTED_MODULE_5__.handleView.handleBookDisplay(clickedBook, bookDescription);
    }
  });

  [hideBookContBtn, hideOverlay].forEach((el) =>
    el.addEventListener("click", () => _view__WEBPACK_IMPORTED_MODULE_5__.handleView.toggleBookContainer())
  );
})();
